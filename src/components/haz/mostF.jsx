...
export default function MostF() {
  ...
  return (
    <div className="bg-white row row-cols-lg-2 shadow px-3 py-2 rounded-4">
      <div>
        <h5 className="pr-color text-center py-3">{t('PPE Alert')}</h5>
