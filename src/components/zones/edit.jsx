...
export default function Edit() {
  ...
  return (
    <div className="pt-4 px-5 zones">
      ...
      <div className="bg-white mx-5 mb-3 shadow row rounded-3">
        ...
        <div className="zone-edit px-5 py-4 d-flex justify-content-between">
          <div className="type-haz">
            ...
            <div className="feats  d-flex justify-content-between mt-4">
              ...
              <div className="feat" onClick={() => handleToggleClick(2)}>
                ...
                <h6 className="pr-color small text-center mt-2">Abnormal</h6>
              </div>
              <div className="feat" onClick={() => handleToggleClick(3)}>
                ...
                <h6 className="pr-color small text-center mt-2">Violation</h6>
              </div>
            </div>
          </div>
        </div>
