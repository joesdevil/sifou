   ...
   return (
      <div className="pt-4 px-5 zones">
         ...
         <div className="bg-white mx-5 mb-3 pb-3 shadow row rounded-3">
            ...
            <div className="zone-edit px-5 pt-4 d-flex justify-content-between">
               <div className="type-haz">
               ...
               <div className="zone-info mt-2 row row-cols-2">
                  <div>
               ...
               <div className="">
                  ...
                  <button className="btn btn-success fw-bold mt-3 mx-1">Apply</button>
                  <button className="btn btn-danger fw-bold mt-3 mx-1">Remove</button>
                  </div>
