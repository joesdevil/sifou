  ...
  return (
    <div className=" p-1 p-sm-5 zones">
      <div className="d-flex justify-content-between mb-4 align-items-center">
        <h3 className="pr-color">All Zones</h3>
        <button className="btn pr-bg text-white btn-sm px-4 py-2" style={{width:"fit-content"}}>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <div className="feats">
                  <div className="feat" onClick={() => handleToggleClick(1)}>
                    <svg
              ...
              <td className="ni fw-bold align-middle fs-5 text-danger">
                283 <i className="bi ps-1 bi-exclamation-triangle-fill"></i>
              </td>
              ...
              <td className="">
                <Link className="link" to="/zones/edit">
                  <button className="btn fw-bold btn-outline-pr">
                    <i class="bi bi-pencil-square"></i> <span>Edit Zone</span>
                  </button>
                </Link>
                <br />
